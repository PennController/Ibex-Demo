...
//
//  IN PROGRESS
//  - Add a SHUFFLE method to ComplexInstr (already implemented in selector)
...
//      t.selector( t("image1.png").id("i1") , t("image2.png").id("i2") ).key( "F", "J" ).save("first image", "second image")
//
//
//  MAYBE
                ...
                var createDistantResource = function (file, host) {
                    ...
                    // IMAGE
                        ...
                        image.bind("load", function() {
                            console.log("Image's ready state: "+this.readyState);
    ...
    class CanvaInstr extends Instruction {
        ...
        run() {
            ...
            for (let o in this.objects) {
                ...
                console.log("Considering "+origin.content+" ("+origin.type+", #"+o+") for canva");
                // If instruction has not been run yet, run it
                if (!origin.hasBeenRun) {
                    console.log("Running "+origin.content+" ("+origin.type+") from canva");
                    origin.run();
        ...
        _addObject(instruction, x, y, z) {
            ...
            console.log("CANVA: before checking");
            ...
            // If instruction has not been run yet, but if CANVA has been run: run instruction
                ...
                console.log("CANVA: this been run");
                origin.done = origin.extend("done", function(){
                    origin.element.css({position: "absolute", left: x, top: y, "z-index": z});
                });
                instruction.run();
            }
            console.log("CANVA: after checking");
        }
        ...
        put(instruction, x, y, z) {
            return this.newMeta(function(){
                console.log("CANVA: about to add");
      ...
      jqueryWidget: {    
        _init: function () {
            ...
            if (_t.toPreload) {
                ...
                console.log(_t.toPreload);
                console.log(_resourcesToPreload);
            }
            //
